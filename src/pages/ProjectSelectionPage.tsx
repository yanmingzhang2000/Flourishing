    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-[#7DC47A] to-[#10B981] text-white py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90">AI 定制你的专属训练计划</p>
          <p className="text-sm text-white/70 mt-2">选择训练目标，开启蜕变之旅</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-3">
          ...
          >
            继续 {selectedProjects.length > 0 && `(${selectedProjects.length})`}
          </Button>
        </div>
